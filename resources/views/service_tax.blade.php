...
<div id="mySidenav" class="sidenav">
    ...
    <a href="http://localhost:63342/bills">Today</a>
    <a href="http://localhost:63342/histories">History</a>
    <div class="dropdown">
...
<button class=buttons id="addButton">Add Service and Tax</button>

<div id="myModal" class="modal">
    <div class="modal-content">
        <form action = "/servicetax" method="POST">
